...
const Connections = () => {
   ...
   catch(err)
   {
    ...
    useEffect(()=>{
     ...
     if(connections.length ===0) return <h1 className="flex justify-center items-center font-bold text-3xl text-pink-500 mt-48">No connections Found</h1>
  return (
    <div className="text-center my-10">
        ...
        {connections?.map((connection) =>{
          ...
          return(
              <div key={connection.id} className="flex ml-96 bg-gray-600 mt-10 w-1/2 rounded-lg h-[150px] p-3">
                <div>
